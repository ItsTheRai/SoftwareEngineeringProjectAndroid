...
prx.types.material_textfield = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		cR += '#'+_id+' input, #'+_id+' .faux-input { color: '+prx.utils.getColor(item.textColor)+'; font-size: '+item.textSize+'px; '+prx.componentsHelper.getFontCssFromFontFamily(item.textFont)+' border-bottom: '+item.borderWidth+'px solid '+prx.utils.getColor(item.borderColor)+'; text-align: '+item.textAlign+'; '+ _props + ' }';
		if(!item.hasIcon) {
		cR += '#'+_id+' input, #'+_id+' .faux-input { width: '+dims.width+'px; }';
		}
		if(item.isFull) { 
...
prx.types.material_textfield_floating_label = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		cR += '#'+_id+' { background-color: '+prx.utils.getColor(item.backgroundColor)+';}';
		cR += '#'+_id+' input, #'+_id+' textarea, #'+_id+' .faux-input { color: '+prx.utils.getColor(item.textColor)+'; font-size: '+item.textSize+'px; '+prx.componentsHelper.getFontCssFromFontFamily(item.textFont)+' border-bottom: '+item.borderWidth+'px solid '+prx.utils.getColor(item.borderColor)+'; text-align: '+item.textAlign+'; '+ _props + ' width: '+dims.width+'px; }';
		cR += '#'+_id+' .label { '+prx.componentsHelper.getFontCssFromFontFamily(item.labelFont)+' font-size: '+item.textSize+'px; color: '+prx.utils.getColor(item.labelColor)+'; text-align: '+item.labelAlign+'; '+ _props + ' }';
		cR += '#'+_id+' .faux-input { '+prx.css.flexJustifyContent(item.textAlign)+'; }';
		...
		if(prx.editor) {
			...
			cR += '<div class="label '+((item.fieldtype == 'textarea') ? 'textarea ' : '')+'liveUpdate-labelColor changeProperty-labelAlign changeProperty-labelFont">'+item.label+'</div>'
			cR += '</div>';
		}
		else {
			cR += '<div class="material-floating-label-field-wrapper">';
...
prx.types.material_bottomsheet_complex = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		for(var i=0; i<item.listitems.length; i++)
			if(typeof(item.listitems[i].iconLeft) != "undefined" && item.listitems[i].iconLeft.fileId != '') {
				hasLeftIcon = true;
				break;
			}
		var hasRightIcon = false;
		for(var i=0; i<item.listitems.length; i++)
			if(typeof(item.listitems[i].iconRight) != "undefined" && item.listitems[i].iconRight.fileId != '') {
				hasLeftIcon = true;
				break;
			}
		...
		$.each(item.listitems, function(i,elm){	
			...
			if(elm.itemtype == 'separator') {
				...
				var iconR = '';
				var thumb = '';
				if(((elm.leftIcon.fileId != '') && (elm.itemtype == 'actionItem' || elm.itemtype == 'infoItem')) || (hasLeftIcon && (!elm.itemtype == 'actionTitle'))) {
				...
				else if(((elm.thumbnail.fileId != '') && (elm.itemtype == 'infoTitle')) || (hasThumbs && (!elm.itemtype == 'actionTitle'))) {
					thumb += '<div class="material-bottomsheet-icon-wrapper"><div class="material-bottomsheet-thumb"></div></div>';
				}
				if(((elm.rightIcon.fileId != '') && (elm.itemtype == 'infoItem')) || (hasRightIcon && (!elm.itemtype == 'actionTitle'))) {
...
prx.types.material_list_complex = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		for(var i=0; i<item.listitems.length; i++) {
			if(typeof(item.listitems[i].thumbnail) != "undefined" && item.listitems[i].thumbnail.fileId != '' && item.thumbpos == 'left') {
				hasThumbLeft = true;
				break;
			}
		}
		for(var i=0; i<item.listitems.length; i++) {
			if(typeof(item.listitems[i].imgSrc) != "undefined" && item.listitems[i].imgSrc.fileId != '' && item.iconpos == 'left') {
				hasIconLeft = true;
				break;
			}
		}
		for(var i=0; i<item.listitems.length; i++) {
			if(typeof(item.listitems[i].imgSrc) != "undefined" && item.listitems[i].imgSrc.fileId != '' && item.iconpos == 'right') {
				hasIconRight = true;
				break;
			}
		}
		for(var i=0; i<item.listitems.length; i++) {
			if(typeof(item.listitems[i].thumbnail) != "undefined" && item.listitems[i].thumbnail.fileId != '' && item.thumbpos == 'right') {
				hasThumbRight = true;
				break;
			}
		}
		...
		$.each(item.listitems, function(i,elm){	
			...
			if((hasIconRight || hasIconLeft) && elm.imgSrc.fileId != '') {
			...
			if((hasThumbRight || hasThumbLeft) && elm.thumbnail.fileId != '') {
			...
			cR += '#' + _id + ' .material-list-switch.checkbox { background-color: '+prx.utils.getColor(item.checkInactiveBackground)+'; }';
			cR += '#' + _id + ' .material-list-switch.radio { width: '+Math.round(listItemH/2.5)+'px; height: '+Math.round(listItemH/2.5)+'px; background-color: '+prx.utils.getColor(item.radioBackgroundColor)+'; border-color: '+prx.utils.getColor(item.radioInactiveColor)+'; }';
			cR += '#' + _id + ' .material-list-switch.checkbox .check { background-color: '+prx.utils.getColor(item.checkCheckmarkColor)+'; }';
			cR += '#' + _id + ' input:checked + label .material-list-switch.checkbox { background-color: '+prx.utils.getColor(item.checkActiveColor)+'; border-color: '+prx.utils.getColor(item.checkActiveColor)+'; }';
			cR += '#' + _id + ' input:checked + label .material-list-switch.radio .circle { background-color: '+prx.utils.getColor(item.radioActiveColor)+';}';
			cR += '#' + _id + ' input:checked + label .material-list-switch.radio { border-color: '+prx.utils.getColor(item.radioActiveColor)+'; }';
			...
			if(item.thumbpos == "left" && elm.thumbnail.fileId != '') {cR += thumb; }
			if(hasThumbLeft && (elm.thumbnail.fileId == '' || (item.thumbpos == "right" && elm.thumbnail.fileId != ''))) cR += '<div class="material-list-icon-wrapper left thumb"></div>';
			
			if(item.iconpos == "left" && elm.imgSrc.fileId != '') { cR += icon; }
			if(hasIconLeft && (elm.imgSrc.fileId == '' || (item.iconpos == "right" && elm.imgSrc.fileId != ''))) cR += '<div class="material-list-icon-wrapper left"></div>';
			...
			if(elm.itemtype == 'withCheckbox' || elm.itemtype == 'withRadio') { 				
				cR += '<div class="material-list-switch '+((elm.itemtype == 'withCheckbox') ? 'checkbox '+((elm.checked == true) ? 'liveUpdate-checkActiveColor-background-color liveUpdate-checkActiveColor-border-color changeProperty-checkActiveColor-background-color changeProperty-checkActiveColor-border-color' : 'liveUpdate-checkInactiveColor liveUpdate-checkInactiveBackground changeProperty-checkInactiveColor changeProperty-checkInactiveBackground')+'' : 'radio liveUpdate-radioBackgroundColor changeProperty-radioBackgroundColor '+((elm.checked == true) ? 'liveUpdate-radioActiveColor-border-color changeProperty-radioActiveColor-border-color' : 'liveUpdate-radioInactiveColor changeProperty-radioInactiveColor')+'')+'">';
				cR += '<div class="';
				if(elm.itemtype == 'withCheckbox') { cR += 'check-container" data-clickable="true"><div class="check short '+((elm.checked == true) ? 'liveUpdate-checkCheckmarkColor changeProperty-checkCheckmarkColor' : '')+'"></div><div class="check long '+((elm.checked == true) ? 'liveUpdate-checkCheckmarkColor changeProperty-checkCheckmarkColor' : '')+'"></div>';}
				if(elm.itemtype == 'withRadio') { cR += 'circle liveUpdate-radioActiveColor-background-color changeProperty-radioActiveColor-background-color">';}
				cR += '</div>';
				cR += '</div>';
			}

			if(elm.itemtype != 'withCheckbox' && elm.itemtype != 'withRadio' && item.iconpos == "right" && elm.imgSrc.fileId != '') { cR += icon; }
			if(elm.itemtype != 'withCheckbox' && elm.itemtype != 'withRadio' && hasIconRight && (elm.imgSrc.fileId == '' || (item.iconpos == "left" && elm.imgSrc.fileId != ''))) { cR += '<div class="material-list-icon-wrapper right"></div>';}
	
			if(elm.itemtype != 'withCheckbox' && elm.itemtype != 'withRadio' && item.thumbpos == "right" && elm.thumbnail.fileId != '') {cR += thumb; }
			if(elm.itemtype != 'withCheckbox' && elm.itemtype != 'withRadio' &&hasThumbRight && (elm.thumbnail.fileId == '' || (item.thumbpos == "left" && elm.thumbnail.fileId != ''))) { cR += '<div class="material-list-icon-wrapper right thumb"></div>';}
				...
				properties: [[
					{
						...
						onChange: function(item, index) {
							...
							case 'basic':
								...
								$('#property-checked, #property-activeColor, #property-checkColor, #property-inactiveColor, #property-borderColorCheck').hide();
								return item;
								break;
							case 'withAvatar':
								item.thumbnail = {"fileId":"a338528b56a2f91841e8b97b1dd11fd9.png","assetType":"gallery","bucketsource":"main","name":" avatar_female.png"};
								item.imgSrc = {"fileId":"","name":"","assetType":"icon","url":""};
								$('#property-checked, #property-activeColor, #property-checkColor, #property-inactiveColor, #property-borderColorCheck').hide();
								return item;
								break;
							...
							case 'withRadio':
								item.thumbnail = {"fileId":"","name":"","assetType":""};
								item.imgSrc = {"fileId":"","name":"","assetType":"icon","url":""};
								$('#property-checked, #property-activeColor, #property-checkColor, #property-inactiveColor, #property-borderColorCheck').show();
								return item;
								break;							
							default: break;
							}
...
prx.components.material_navigationbar = {
	...
	,icon1: {"fileId":"c6cedf8d131daea6f649decdd0a41eb7.png","assetType":"gallery","bucketsource":"main","name":" sysbar_back.png"}
	,icon2: {"fileId":"87655268eb58c1c33f29601e55ad68f0.png","assetType":"gallery","bucketsource":"main","name":" sysbar_home.png"}
	,icon3: {"fileId":"3184654843a471d3b719ef02b9eb3a3c.png","assetType":"gallery","bucketsource":"main","name":" sysbar_recent.png"}
}
