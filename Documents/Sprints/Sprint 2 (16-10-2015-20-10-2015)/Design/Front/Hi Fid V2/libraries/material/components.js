...
prx.types.material_tabbar_fixed = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {	
		...
		cR += '#' + _id + ' .material-tabbar-fixed-list-item label { font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; '+prx.componentsHelper.getProp(item.textFont,'font-family')+' '+_props+' }';
...
prx.types.material_tabbar_scrollable = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		$.each(tabs, function(i,elm){
			...
			cR += '<li class="material-tabbar-scrollable-list-item liveUpdate-backgroundColor changeProperty-backgroundColor dynamic-property '+((prx.componentsHelper.getProp(item.rippleEffect,'boolean')) ? 'prx-material-ripple' : '' )+'" data-dynamic-property-index="'+i+'" id="'+_id+'-tabs-'+i+'">';
...
prx.types.material_tabbar_segmented_button = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {	
		...
		$.each(item.tabs, function(i,elm){			
			...
			cR += '<style>';
			if( prx.componentsHelper.getProp(elm.imgSrc.url,'other') != '' ) {
...
prx.types.material_button_raised = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {		
		...
		cR += '#' + _id + ' .material-button-container { '+prx.componentsHelper.getProp(item.textFont,'font-family')+' '+_props+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; }';
		}
		else {
...
prx.types.material_textfield = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		if(prx.componentsHelper.getProp(item.hasIcon,'boolean') && prx.componentsHelper.getProp(item.imgSrc.fileId,'other') != '') {
...
prx.types.material_textfield_floating_label = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		if(prx.editor) {
			...
			cR += '<div class="faux-input '+((prx.componentsHelper.getProp(item.fieldtype,'other')== 'textarea') ? 'textarea ' : '')+'liveUpdate-textColor liveUpdate-borderColor liveUpdate-backgroundColor" data-editableproperty="value">'+prx.componentsHelper.getProp(item.value,'text')+'</div>';
...
prx.types.material_bottomsheet_complex = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		for(var i=0; i<item.listitems.length; i++)
			if(typeof(item.listitems[i].thumbnail,'other') != "undefined" && prx.componentsHelper.getProp(item.listitems[i].thumbnail.fileId,'other') != '') {
				hasThumbs = true;
				break;
			}
		var hasLeftIcon = false;
		for(var i=0; i<item.listitems.length; i++)
			if(typeof(item.listitems[i].leftIcon,'other') != "undefined" && prx.componentsHelper.getProp(item.listitems[i].leftIcon.fileId,'other') != '') {
				hasLeftIcon = true;
				break;
			}
		var hasRightIcon = false;
		for(var i=0; i<item.listitems.length; i++)
			if(typeof(item.listitems[i].rightIcon,'other') != "undefined" && prx.componentsHelper.getProp(item.listitems[i].rightIcon.fileId,'other') != '') {
				hasRightIcon = true;
				break;
			}
			...
			if(prx.componentsHelper.getProp(elm.itemtype,'other') == 'separator') {
				...
				cR += '<div class="bordered-container '+((prx.componentsHelper.getProp(item.rippleEffect,'boolean') && 
															!(prx.componentsHelper.getProp(elm.itemtype,'other') == 'separator' || 
																...
																? 'prx-material-ripple ' : '' )+'liveUpdate-dividerColor changeProperty-dividerColor">';
...
prx.types.material_list_complex = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		for(var i=0; i<item.listitems.length; i++) {
			if(typeof(item.listitems[i].thumbnail) != "undefined" && prx.componentsHelper.getProp(item.listitems[i].thumbnail.fileId,'other') != '' && prx.componentsHelper.getProp(item.thumbpos,'icon-position') == 'left') {
				hasThumbLeft = true;
				break;
			}
		}
		for(var i=0; i<item.listitems.length; i++) {
			if(typeof(item.listitems[i].imgSrc) != "undefined" && prx.componentsHelper.getProp(item.listitems[i].imgSrc.fileId,'other') != '' && prx.componentsHelper.getProp(item.iconpos,'icon-position') == 'left') {
				hasIconLeft = true;
				break;
			}
		}
		for(var i=0; i<item.listitems.length; i++) {
			if(typeof(item.listitems[i].imgSrc) != "undefined" && prx.componentsHelper.getProp(item.listitems[i].imgSrc.fileId,'other') != '' && prx.componentsHelper.getProp(item.iconpos,'icon-position') == 'right') {
				hasIconRight = true;
				break;
			}
		}
		for(var i=0; i<item.listitems.length; i++) {
			if(typeof(item.listitems[i].thumbnail) != "undefined" && prx.componentsHelper.getProp(item.listitems[i].thumbnail.fileId,'other') != '' && prx.componentsHelper.getProp(item.thumbpos,'icon-position') == 'right') {
				hasThumbRight = true;
				break;
			}
		}
		...
		var _subprops = prx.componentsHelper.getProp(item.subtitleProperties,'props-text');	
		...
		$.each(item.listitems, function(i,elm){	
			...
			if((hasIconRight || hasIconLeft) && prx.componentsHelper.getProp(elm.imgSrc.fileId,'other') != '') {
			...
			if((hasThumbRight || hasThumbLeft) && prx.componentsHelper.getProp(elm.thumbnail.fileId,'other') != '') {
			...
			cR += '#' + _id + ' .material-list-switch.checkbox { background-color: '+prx.componentsHelper.getProp(item.checkInactiveBackground,'color-background')+'; }';
			...
			if( prx.componentsHelper.getProp(elm.itemtype,'other') != 'withCheckbox' && 
					prx.componentsHelper.getProp(elm.itemtype,'other') != 'withRadio' && 
					prx.componentsHelper.getProp(item.thumbpos,'icon-position') == "right" && 
...
prx.types.material_toast = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		cR += '<div class="material-toast-inner liveUpdate-textColor changeProperty-text changeProperty-textFont changeProperty-textSize changeProperty-textColor"><span data-editableproperty="text">' + prx.componentsHelper.getProp(item.text,'text') + '</span></div>';
		cR += '</div>'
		cR += '</div>'
		return cR;
	}
...
prx.types.material_snackbar_action = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var _actionprops = prx.componentsHelper.getProp(item.actionProperties,'props-text');
		}
		...
		cR += '<div class="material-snackbar-text liveUpdate-textColor changeProperty-textColor changeProperty-textSize changeProperty-textFont actions-actions1"><span data-editableproperty="text">'+prx.componentsHelper.getProp(item.text,'text')+'</span></div>';
		if(prx.componentsHelper.getProp(item.hasAction,'boolean')) {
		cR += '<div class="material-snackbar-action-text liveUpdate-actionColor changeProperty-actiontColor changeProperty-actionSize changeProperty-actionFont actions-actions2 '+((prx.componentsHelper.getProp(item.rippleEffect,'boolean')) ? 'prx-material-ripple' : '' )+'" data-editableproperty="action">'+prx.componentsHelper.getProp(item.action,'text')+'</div>';
		}
		cR += '</div>';
		cR += '</div>';
		return cR;
...
prx.types.material_dialog_alert = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var _titleprops = prx.componentsHelper.getProp(item.titleProperties,'props-text');
		...
		if(item.withTitle) {
		cR += '<div class="material-dialog-title liveUpdate-titleColor changeProperty-titleColor changeProperty-titleSize changeProperty-textFont"><span data-editableproperty="title">'+prx.componentsHelper.getProp(item.title,'text')+'</span></div>';
		}
		cR += '<div class="material-dialog-text liveUpdate-textColor changeProperty-textColor changeProperty-textSize changeProperty-textFont changeProperty-textAlign"><span data-editableproperty="text">'+prx.componentsHelper.getProp(item.text,'text')+'</span></div>';
		...
		$.each(item.buttons, function(i,elm) {
			var _button_props = prx.componentsHelper.getProp(elm.textProperties,'props-text');
...
prx.types.material_dialog_simpledialog = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var hasThumbs = false;
		for(var i=0; i<item.listitems.length; i++)
			if(typeof(item.listitems[i].thumbnail) != "undefined" && prx.componentsHelper.getProp(item.listitems[i].thumbnail.fileId,'other') != '') {
				hasThumbs = true;
				break;
			}
