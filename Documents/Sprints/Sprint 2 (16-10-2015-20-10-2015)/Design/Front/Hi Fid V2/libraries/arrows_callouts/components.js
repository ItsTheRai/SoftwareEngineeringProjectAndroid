...
prx.types.arrow = {
	...
	,onDisplay: function(item,containerid) {
		...
		var cR = '<div id="' + _id + '" class="box pos type-arrow '+prx.componentsHelper.getProp(item.arrowType,'other')+'" ';
...
prx.types.bubble = {
	...
	,onDisplay: function(item,containerid) {
		...
		var cR = '<div id="' + _id + '" class="box pos type-bubble '+prx.componentsHelper.getProp(item.bubbleType,'other')+'" ';
